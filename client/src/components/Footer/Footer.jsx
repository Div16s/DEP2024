...
export function FooterWithSocialLinks() {
  return (
    <div className="flex flex-col flex-shrink-0">
      <footer className="w-full mt-10 border border-gray-300 text-white" style={{backgroundColor:"rgb(0,82,195)",fontStyle:"normal"}}>
        <div className="mx-auto w-full max-w-8xl px-8 mt-2">
          <div className="grid grid-cols-1 justify-between gap-8 md:grid-cols-2">
            <Typography variant="h4" className="mt-1 mb-7 font-semibold text-white">
              Purchase Management
              <br />
              ...
              {LINKS.map(({ title, items }) => (
                <ul key={title}>
                  <Typography
                    variant="4xl"
                    color="white"
                    className="mb-5 font-bold opacity-1000"
                  >
                    {title}
                  </Typography>
                  {items.map((link) => (
